...
const Project = ({ name, image, category, techstack, links }: project) => {
    ...
    return (
        <motion.div
            ...
            className="flex flex-col gap-2 bg-gray-400 dark:bg-grey-800 rounded-lg p-4 overflow-x-hidden">
            ...
            <div className="my-2 flex flex-col gap-3">
                ...
                <p>
                    <a href="/works" target="_blank" className="text-black hover:bg-black hover:text-white hover:p-[1%]">Click here to Visit</a>
                </p>
