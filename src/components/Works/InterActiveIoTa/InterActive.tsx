  ...
  const content = [
    ...
    <>
      <div className="text-xl">
        ...
        Motion Simulation with Acceleration Sensors
        <br />
    ...
    <>
      <div className="text-xl">
        ...
        <div className="flex flex-col gap-4 justify-center items-center">
          ...
          <iframe
            src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7187970862841532416?compact=1"
            height="399"
            width="504"
            frameBorder="0"
            allowFullScreen
  ...
  return (
    <div className="overflow-x-hidden md:overflow-x-auto">
      <div className='sticky-h3 w-fit text-xs' id="hello1">
        ...
        <SectionTitle title="IoT-2" progressBgClass="bg-primary"></SectionTitle>

      </div>
      <div className={`cont md:w-[100%] md:-ml-0 w-[170%] -ml-[35%] bg-cover ${containerActive ? "" : "s--inactive"} ${activeIndex !== null ? "s--el-active" : ""}`}>
              ...
              <div className="el__overflow">
                <div className="el__inner">
                  ...
                  <div className="el__content overflow-y-scroll overflow-x-hidden mx-auto">
                    <div className="el__text">Project Details</div>
...
export default InteractiveIoTa;
