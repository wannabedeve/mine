  ...
  const content = [
    ...
    <>
      <div className="text-xl">
        ...
        <br />
        <ul>
          <li>Proximity Sensor, IoT Enablement Platform, Frontend Visualization, Backend Processing " Nodejs / Python ", Data Transmission: MQTT / HTTP,
          </li>
        </ul>
      </div>
    </>,
    ...
    <>
      <div className="text-xl">
        ...
        <br />
        <ul>
          <li>Real-time ambient light detection using light sensors.</li>
          <li>Automatic control of lighting based on environmental brightness.</li>
          <li>Energy-efficient operation with dynamic light management.</li>
          <li>Configurable light thresholds for different environments.</li>
          <li>Centralized status monitoring via an IoT Enablement Platform.</li>
        </ul>
        <br />
        <p>&darr;</p>
        <br />
        ...
        <ul>
          <li>
            Sensors: Light-dependent resistor (LDR) or digital light sensors " e.g., BH1750 ".
            <br />
            Microcontroller/Device: e.g., Arduino, ESP32, Raspberry Pi.
            <br />
            IoT Enablement Platform, Communication: MQTT / HTTP.
            <br />
            Dashboard: Web interface for manual override and monitoring.
            <br />
  ...
  return (
    <div className="overflow-x-hidden md:overflow-x-auto">
      <div className='sticky-h3 w-fit text-xs' id="hello1">
        ...
        <SectionTitle title="IoT-1" progressBgClass="bg-primary"></SectionTitle>
